                      ...
                      fluidRow(
                        column(12, div(class = "dynamic-height scrollable-content",
                                       wellPanel(tags$small(HTML(paste0(
                                         ...
                                         <p>Die Einteilung der Forschenden in einen von acht Fachbereichen stützt sich auf drei Quellen in absteigender Priorität. Zuerst gilt eine kuratierte Zuordnung einzelner Personen zu einem Fachbereich. Fehlt diese, bestimmt ein lokal betriebenes KI-Sprachmodell (das quelloffene Modell „Qwen 3.5“) den Fachbereich aus den Publikationstiteln. Liefert auch dieses kein Ergebnis, greift eine kuratierte Zuordnung von Einrichtung und Abteilung zum jeweiligen Fachbereich. Die Taxonomie orientiert sich an den <a href=\"https://www.uni-kiel.de/de/universitaet/einrichtungen-fakultaeten/fakultaeten-gemeinsame-einrichtungen\">Fakultäten der CAU</a>, muss mit diesen aber nicht kongruent sein.</p>
             ...
             tabPanel("Impressum",
                      ...
                      fluidRow(
                        column(12, div(class = "dynamic-height scrollable-content",
                                  ...
                                  Ideen und Förderung: <a href=\"https://www.chinazentrum.uni-kiel.de/de/\" target=\"_blank\">Chinazentrum CAU Kiel</a></p>

                                  <p><b>Zitationsvorschlag</b></p><p>Pelzer, Thorben. „Atlas der Ostasien-Forschung in Norddeutschland.“ Kiel: CAU Chinazentrum, 2025. doi: <a href=\"https://doi.org/10.5281/zenodo.17745729\" target=\"_blank\">10.5281/zenodo.17745729</a>. <a href=\"citation.bib\"  download=\"citation.bib\">📚</a></p>
